            ...
            <ScrollFloat key={idx}>
              ...
              >
                ...
                >
                  ...
                  <div className="relative p-5 sm:p-8 flex flex-col sm:flex-row items-start sm:items-center sm:justify-between gap-4">
                    {/* Left: Logo */}
                    ...
                    <div className="flex items-center gap-2 w-full sm:w-auto">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-center gap-2 w-full sm:w-auto px-4 py-2.5 sm:py-0 rounded-lg sm:rounded-none sm:bg-transparent"
                        style={{
